...
CREATE TABLE payment_p2007_01 (CONSTRAINT payment_p2007_01_payment_date_check CHECK (((payment_date >= '2007-01-01 00:00:00'::timestamptz) AND (payment_date < '2007-02-01 00:00:00'::timestamptz)))
)
INHERITS (payment);
...
CREATE TABLE payment_p2007_02 (CONSTRAINT payment_p2007_02_payment_date_check CHECK (((payment_date >= '2007-02-01 00:00:00'::timestamptz) AND (payment_date < '2007-03-01 00:00:00'::timestamptz)))
)
INHERITS (payment);
...
CREATE TABLE payment_p2007_03 (CONSTRAINT payment_p2007_03_payment_date_check CHECK (((payment_date >= '2007-03-01 00:00:00'::timestamptz) AND (payment_date < '2007-04-01 00:00:00'::timestamptz)))
)
INHERITS (payment);
...
CREATE TABLE payment_p2007_04 (CONSTRAINT payment_p2007_04_payment_date_check CHECK (((payment_date >= '2007-04-01 00:00:00'::timestamptz) AND (payment_date < '2007-05-01 00:00:00'::timestamptz)))
)
INHERITS (payment);
...
CREATE TABLE payment_p2007_05 (CONSTRAINT payment_p2007_05_payment_date_check CHECK (((payment_date >= '2007-05-01 00:00:00'::timestamptz) AND (payment_date < '2007-06-01 00:00:00'::timestamptz)))
)
INHERITS (payment);
...
CREATE TABLE payment_p2007_06 (CONSTRAINT payment_p2007_06_payment_date_check CHECK (((payment_date >= '2007-06-01 00:00:00'::timestamptz) AND (payment_date < '2007-07-01 00:00:00'::timestamptz)))
)
INHERITS (payment);
...
--
-- Name: get_customer_balance(integer, timestamptz); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION get_customer_balance(p_customer_id integer, p_effective_date timestamptz) RETURNS numeric
    AS $$
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamptz) OWNER TO postgres;
...
--
-- Name: last_day(timestamptz); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION last_day(timestamptz) RETURNS date
    AS $_$
  SELECT CASE
...
ALTER FUNCTION public.last_day(timestamptz) OWNER TO postgres;
